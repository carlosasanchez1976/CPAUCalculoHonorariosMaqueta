...
BEGIN
  ...
  IF p_calculo_id IS NULL THEN
    ...
    BEGIN
      INSERT INTO Calculos (usuario_id, tarea_id, fecha_calculo, proyecto_nombre, proyecto_ubicacion, proyecto_cliente, proyecto_observ, obra_valor_obra, obra_superficie, obra_cotiz_dolar, obra_tipologia, obra_complejidad, tarea_obra_proyecto, tarea_obra_direccion, tarea_instalacion_sanitaria, tarea_instalacion_electrica, tarea_instalacion_contra_incendio, tarea_instalacion_termomecanica, tarea_proyecto_estructuras, tarea_documentacion_ejecutiva, tarea_supervision_obra, tarea_observaciones)
      VALUES (p_usuario_id, p_tarea_id, p_fecha_calculo, p_proyecto_nombre, p_proyecto_ubicacion, p_proyecto_cliente, p_proyecto_observ, p_obra_valor_obra, p_obra_superficie, p_obra_cotiz_dolar, p_obra_tipologia, p_obra_complejidad, p_tarea_obra_proyecto, p_tarea_obra_direccion, p_tarea_instalacion_sanitaria, p_tarea_instalacion_electrica, p_tarea_instalacion_contra_incendio, p_tarea_instalacion_termomecanica, p_tarea_proyecto_estructuras, p_tarea_documentacion_ejecutiva, p_tarea_supervision_obra, p_tarea_observaciones);
